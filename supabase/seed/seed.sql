...
values
  (
    ...
    true,
    'investigation',
    'investigation.social_echo.reveal_recent_interactions',
    'other_participant',
    0,
    true,
    1,
    'Obtiens un indice social sur un autre participant.',
    'Révèle au joueur un résumé des interactions récentes de la cible.'
  ),
  (
    'Fenêtre tactique',
    1,
    ...
    true,
    'tempo',
    'tempo.window.extend_claim_time_short',
    'self',
    90,
    true,
    1,
    'Gagne un court délai pour finaliser une action en cours.',
    'Applique une extension temporelle courte sur la fenêtre de validation.'
  ),
  (
    'Parade réflexe',
    1,
    ...
    true,
    'defense',
    'defense.reactive.block_next_minor_penalty',
    'self',
    180,
    true,
    1,
    'Protège-toi contre la prochaine petite pénalité.',
    'Ajoute un bouclier consommé à la première pénalité mineure reçue.'
  ),
  (
    'Bonus de conversion',
    2,
    ...
    true,
    'value',
    'value.conversion.double_next_reward_tokens',
    'self',
    0,
    true,
    1,
    'Double les jetons gagnés sur ton prochain gain compatible.',
    'Multiplie par deux le prochain événement de gain de jetons autorisé.'
  ),
  (
    'Relance de pari',
    2,
    ...
    true,
    'wager',
    'wager.risk.recommit_with_higher_stake',
    'self',
    0,
    true,
    1,
    'Rejoue une prise de risque avec enjeu augmenté.',
    'Permet une seconde tentative de pari avec coût/impact majorés.'
  ),
  (
    'Montée de pression',
    2,
    ...
    true,
    'pressure',
    'pressure.target.force_response_under_timer',
    'other_participant',
    120,
    true,
    1,
    'Force une réponse rapide de la cible.',
    'Impose une fenêtre de réponse contrainte à un autre participant.'
  ),
  (
    'Mise en lumière',
    3,
    ...
    true,
    'exposure',
    'exposure.target.reveal_hidden_constraint_tag',
    'other_participant',
    0,
    true,
    1,
    'Révèle un marqueur caché lié à un autre participant.',
    'Expose un tag de contrainte cachée côté cible selon règles d’arbitrage.'
  )
