...
values
  (
    ...
    true,
    'investigation',
    'reveal_partial_profile',
    'other_player',
    0,
    true,
    1,
    'Révèle un indice partiel sur un joueur ciblé.',
    'Expose un fragment de profil pour accélérer l’enquête sociale.'
  ),
  (
    'Scanner de piste',
    2,
    ...
    true,
    'investigation',
    'inspect_recent_action',
    'other_participant',
    0,
    true,
    1,
    'Permet d’inspecter la dernière action visible d’un participant.',
    'Retourne une trace runtime récente pour investigation tactique.'
  ),
  (
    'Sursis éclair',
    1,
    ...
    true,
    'tempo',
    'extend_mission_window_60',
    'self',
    60,
    true,
    1,
    'Ajoute 60 secondes à votre fenêtre d’action en cours.',
    'Allonge la fenêtre temporelle d’exécution d’un élément actif.'
  ),
  (
    'Gel court',
    2,
    ...
    true,
    1,
    'Ralentit temporairement un participant ciblé pendant 5 minutes.',
    'Applique un blocage tempo de 300 secondes sur la cible sessionnelle.'
  ),
  (
    'Retard stratégique',
    3,
    ...
    true,
    'tempo',
    'delay_next_assignment_900',
    'other_participant',
    900,
    true,
    1,
    'Décale la prochaine attribution de la cible de 15 minutes.',
    'Injecte un délai de 900 secondes dans la boucle d’assignation.'
  ),
  (
    'Bouclier rapide',
    1,
    ...
    true,
    'protection',
    'shield_from_accusation_60',
    'self',
    60,
    true,
    1,
    'Vous protège brièvement contre une accusation.',
    'Fenêtre de protection anti-accusation pendant 60 secondes.'
  ),
  (
    'Parade immédiate',
    2,
    ...
    true,
    'defense',
    'negate_next_pressure',
    'self',
    0,
    true,
    1,
    'Annule le prochain effet de pression subi.',
    'Consomme un slot défensif pour neutraliser le prochain effet hostile.'
  ),
  (
    'Pression publique',
    1,
    ...
    true,
    1,
    'Force la cible à exposer un indice public.',
    'Déclenche une contrainte de divulgation limitée côté cible joueur.'
  ),
  (
    'Verrou de skip',
    3,
    ...
    true,
    1,
    'Empêche la cible d’utiliser un skip pendant 5 minutes.',
    'Bloque la mécanique de skip pour la cible pendant 300 secondes.'
  ),
  (
    'Ristourne jeton',
    2,
    ...
    true,
    1,
    'Rend 1 jeton après votre prochain achat validé.',
    'Applique un remboursement conditionnel pour tester la famille value.'
  ),
  (
    ...
    true,
    1,
    'Déclenche une interaction sociale dirigée vers un autre joueur.',
    'Point d’entrée pour les effets sociaux pilotés par effect_code.'
  )
